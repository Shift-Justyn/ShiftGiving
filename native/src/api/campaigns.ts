...
import { Campaign, CampaignQueryParams, Organization, OrganizationDetail } from './types';
...
export const getOrganizationById = (id: string): Promise<OrganizationDetail> => {
  return get<OrganizationDetail>(`/api/organizations/${id}`);
};
